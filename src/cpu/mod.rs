...
use crate::hook::{self, HookEvent, Hooks, set_hook_event};
use crate::syncunsafecell::{SyncUnsafeCell, ptr_to_ref_mut};
use crate::{Address, NUM_CPUS, PhyAddress};
...
unsafe fn cpu_tracking(id: u32) -> &'static mut Tracking {
    unsafe { &mut ptr_to_ref_mut(CPU_TRACKING.0.get())[id as usize] }
}

pub(crate) unsafe fn run_state(id: u32) -> RunState {
    unsafe { cpu_tracking(id).state }
}
...
impl Cpu {
    ...
    pub unsafe fn seed(&self) -> u64 {
        unsafe { seed(self.handle) }
    }

    pub unsafe fn set_seed(&self, new_seed: u64) {
        unsafe { set_seed(self.handle, new_seed) }
    }
    ...
    pub unsafe fn rax(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rax as _) }
    }

    pub unsafe fn set_rax(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::Rax as _, v) }
    }

    pub unsafe fn rcx(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rcx as _) }
    }

    pub unsafe fn set_rcx(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::Rcx as _, v) }
    }

    pub unsafe fn rdx(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rdx as _) }
    }

    pub unsafe fn set_rdx(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::Rdx as _, v) }
    }

    pub unsafe fn rbx(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rbx as _) }
    }

    pub unsafe fn set_rbx(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::Rbx as _, v) }
    }

    pub unsafe fn rsp(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rsp as _) }
    }
    ...
    pub unsafe fn rbp(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rbp as _) }
    }

    pub unsafe fn set_rbp(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::Rbp as _, v) }
    }

    pub unsafe fn rsi(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rsi as _) }
    }

    pub unsafe fn set_rsi(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::Rsi as _, v) }
    }

    pub unsafe fn rdi(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::Rdi as _) }
    }

    pub unsafe fn set_rdi(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::Rdi as _, v) }
    }

    pub unsafe fn r8(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R8 as _) }
    }

    pub unsafe fn set_r8(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R8 as _, v) }
    }

    pub unsafe fn r9(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R9 as _) }
    }

    pub unsafe fn set_r9(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R9 as _, v) }
    }

    pub unsafe fn r10(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R10 as _) }
    }

    pub unsafe fn set_r10(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R10 as _, v) }
    }

    pub unsafe fn r11(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R11 as _) }
    }

    pub unsafe fn set_r11(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R11 as _, v) }
    }

    pub unsafe fn r12(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R12 as _) }
    }

    pub unsafe fn set_r12(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R12 as _, v) }
    }

    pub unsafe fn r13(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R13 as _) }
    }

    pub unsafe fn set_r13(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R13 as _, v) }
    }

    pub unsafe fn r14(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R14 as _) }
    }

    pub unsafe fn set_r14(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R14 as _, v) }
    }

    pub unsafe fn r15(&self) -> u64 {
        unsafe { cpu_get_reg64(self.handle, GpRegs::R15 as _) }
    }

    pub unsafe fn set_r15(&self, v: u64) {
        unsafe { cpu_set_reg64(self.handle, GpRegs::R15 as _, v) }
    }

    pub unsafe fn rflags(&self) -> u64 {
        unsafe { cpu_get_eflags(self.handle) as _ }
    }

    pub unsafe fn set_rflags(&self, v: u64) {
        unsafe { cpu_set_eflags(self.handle, v as _) }
    }
    ...
    pub unsafe fn set_gdtr(&self, gdtr: GlobalSeg) {
        unsafe { cpu_set_gdtr(self.handle, gdtr.base, gdtr.limit) }
    }
    ...
    pub unsafe fn set_idtr(&self, idtr: GlobalSeg) {
        unsafe { cpu_set_idtr(self.handle, idtr.base, idtr.limit) }
    }

    // debug registers

    pub unsafe fn dr0(&self) -> Address {
        unsafe { cpu_get_dr(self.handle, DRegs::Dr0 as _) }
    }

    pub unsafe fn set_dr0(&self, v: Address) {
        unsafe { cpu_set_dr(self.handle, DRegs::Dr0 as _, v) }
    }

    pub unsafe fn dr1(&self) -> Address {
        unsafe { cpu_get_dr(self.handle, DRegs::Dr1 as _) }
    }

    pub unsafe fn set_dr1(&self, v: Address) {
        unsafe { cpu_set_dr(self.handle, DRegs::Dr1 as _, v) }
    }

    pub unsafe fn dr2(&self) -> Address {
        unsafe { cpu_get_dr(self.handle, DRegs::Dr2 as _) }
    }

    pub unsafe fn set_dr2(&self, v: Address) {
        unsafe { cpu_set_dr(self.handle, DRegs::Dr2 as _, v) }
    }

    pub unsafe fn dr3(&self) -> Address {
        unsafe { cpu_get_dr(self.handle, DRegs::Dr3 as _) }
    }

    pub unsafe fn set_dr3(&self, v: Address) {
        unsafe { cpu_set_dr(self.handle, DRegs::Dr3 as _, v) }
    }

    pub unsafe fn dr6(&self) -> u32 {
        unsafe { cpu_get_dr6(self.handle) }
    }

    pub unsafe fn set_dr6(&self, v: u32) {
        unsafe { cpu_set_dr6(self.handle, v) }
    }

    pub unsafe fn dr7(&self) -> u32 {
        unsafe { cpu_get_dr7(self.handle) }
    }

    pub unsafe fn set_dr7(&self, v: u32) {
        unsafe { cpu_set_dr7(self.handle, v) }
    }

    // control registers

    pub unsafe fn cr0(&self) -> u32 {
        unsafe { cpu_get_cr0(self.handle) }
    }
    ...
    pub unsafe fn cr2(&self) -> Address {
        unsafe { cpu_get_cr2(self.handle) }
    }

    pub unsafe fn set_cr2(&self, v: Address) {
        unsafe { cpu_set_cr2(self.handle, v) }
    }

    pub unsafe fn cr3(&self) -> Address {
        unsafe { cpu_get_cr3(self.handle) }
    }

    pub unsafe fn set_cr3(&self, v: Address) {
        unsafe { cpu_set_cr3(self.handle, v) }
    }

    pub unsafe fn cr4(&self) -> u32 {
        unsafe { cpu_get_cr4(self.handle) }
    }

    pub unsafe fn set_cr4(&self, v: u32) {
        unsafe { cpu_set_cr4(self.handle, v) }
    }

    pub unsafe fn cr8(&self) -> u64 {
        unsafe { cpu_get_cr8(self.handle) as _ }
    }

    pub unsafe fn set_cr8(&self, v: u64) {
        unsafe { cpu_set_cr8(self.handle, v as _) }
    }

    pub unsafe fn efer(&self) -> u32 {
        unsafe { cpu_get_efer(self.handle) }
    }
    ...
    pub unsafe fn set_mode(&self) {
        unsafe { cpu_set_mode(self.handle) }
    }

    pub unsafe fn xcr0(&self) -> u32 {
        unsafe { cpu_get_xcr0(self.handle) }
    }

    pub unsafe fn set_xcr0(&self, v: u32) {
        unsafe { cpu_set_xcr0(self.handle, v) }
    }

    // msrs

    pub unsafe fn kernel_gs_base(&self) -> u64 {
        unsafe { cpu_get_kernel_gs_base(self.handle) }
    }

    pub unsafe fn set_kernel_gs_base(&self, v: u64) {
        unsafe { cpu_set_kernel_gs_base(self.handle, v) }
    }

    pub unsafe fn sysenter_cs(&self) -> u64 {
        unsafe { cpu_get_sysenter_cs(self.handle) as _ }
    }

    pub unsafe fn set_sysenter_cs(&self, v: u64) {
        unsafe { cpu_set_sysenter_cs(self.handle, v as _) }
    }

    pub unsafe fn sysenter_eip(&self) -> Address {
        unsafe { cpu_get_sysenter_eip(self.handle) }
    }

    pub unsafe fn set_sysenter_eip(&self, v: Address) {
        unsafe { cpu_set_sysenter_eip(self.handle, v) }
    }

    pub unsafe fn sysenter_esp(&self) -> Address {
        unsafe { cpu_get_sysenter_esp(self.handle) }
    }

    pub unsafe fn set_sysenter_esp(&self, v: Address) {
        unsafe { cpu_set_sysenter_esp(self.handle, v) }
    }

    pub unsafe fn star(&self) -> u64 {
        unsafe { cpu_get_star(self.handle) }
    }

    pub unsafe fn set_star(&self, v: u64) {
        unsafe { cpu_set_star(self.handle, v) }
    }

    pub unsafe fn lstar(&self) -> u64 {
        unsafe { cpu_get_lstar(self.handle) }
    }

    pub unsafe fn set_lstar(&self, v: u64) {
        unsafe { cpu_set_lstar(self.handle, v) }
    }

    pub unsafe fn cstar(&self) -> u64 {
        unsafe { cpu_get_cstar(self.handle) }
    }

    pub unsafe fn set_cstar(&self, v: u64) {
        unsafe { cpu_set_cstar(self.handle, v) }
    }

    pub unsafe fn sfmask(&self) -> u64 {
        unsafe { cpu_get_fmask(self.handle) as _ }
    }

    pub unsafe fn set_sfmask(&self, v: u64) {
        unsafe { cpu_set_fmask(self.handle, v as _) }
    }

    pub unsafe fn tsc(&self) -> u64 {
        unsafe { cpu_get_tsc(self.handle) }
    }

    pub unsafe fn set_tsc(&self, v: u64) {
        unsafe { cpu_set_tsc(self.handle, v) }
    }

    pub unsafe fn apic_base(&self) -> PhyAddress {
        unsafe { cpu_get_apicbase(self.handle) }
    }

    pub unsafe fn set_apic_base(&self, v: PhyAddress) {
        unsafe { cpu_set_apicbase(self.handle, v) }
    }

    pub unsafe fn pat(&self) -> u64 {
        unsafe { cpu_get_pat(self.handle) }
    }

    pub unsafe fn set_pat(&self, v: u64) {
        unsafe { cpu_set_pat(self.handle, v) }
    }

    pub unsafe fn tsc_aux(&self) -> u64 {
        unsafe { cpu_get_tsc_aux(self.handle) as _ }
    }
    ...
    pub unsafe fn mxcsr(&self) -> u32 {
        unsafe { cpu_get_mxcsr(self.handle) }
    }

    pub unsafe fn set_mxcsr(&self, v: u32) {
        unsafe { cpu_set_mxcsr(self.handle, v) }
    }

    pub unsafe fn mxcsr_mask(&self) -> u32 {
        unsafe { cpu_get_mxcsr_mask(self.handle) }
    }

    pub unsafe fn set_mxcsr_mask(&self, v: u32) {
        unsafe { cpu_set_mxcsr_mask(self.handle, v) }
    }

    // FP

    pub unsafe fn fp_cw(&self) -> u16 {
        unsafe { cpu_get_fp_cw(self.handle) }
    }

    pub unsafe fn set_fp_cw(&self, v: u16) {
        unsafe { cpu_set_fp_cw(self.handle, v) }
    }

    pub unsafe fn fp_sw(&self) -> u16 {
        unsafe { cpu_get_fp_sw(self.handle) }
    }

    pub unsafe fn set_fp_sw(&self, v: u16) {
        unsafe { cpu_set_fp_sw(self.handle, v) }
    }

    pub unsafe fn fp_tw(&self) -> u16 {
        unsafe { cpu_get_fp_tw(self.handle) }
    }

    pub unsafe fn set_fp_tw(&self, v: u16) {
        unsafe { cpu_set_fp_tw(self.handle, v) }
    }

    pub unsafe fn fp_op(&self) -> u16 {
        unsafe { cpu_get_fp_op(self.handle) }
    }

    pub unsafe fn set_fp_op(&self, v: u16) {
        unsafe { cpu_set_fp_op(self.handle, v) }
    }
