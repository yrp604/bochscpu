...
// XXX bochscpu
int bx_param_num_c::text_ask() { abort(); }
// XXX bochscpu
void bx_param_num_c::text_print() { abort(); }
...
// XXX bochscpu
int bx_param_bool_c::text_ask() { abort(); }
// XXX bochscpu
void bx_param_bool_c::text_print() { abort(); }
...
// XXX bochscpu
int bx_param_enum_c::text_ask() { abort(); }
// XXX bochscpu
void bx_param_enum_c::text_print() { abort(); }
...
// XXX bochscpu
int bx_param_string_c::text_ask() { abort(); }
// XXX bochscpu
void bx_param_string_c::text_print() { abort(); }
...
// XXX bochscpu
int bx_list_c::text_ask() { abort(); }
// XXX bochscpu
void bx_list_c::text_print() { abort(); }
